...
<body class="<?php echo isset($_SESSION['bg']) ?  $_SESSION['bg'] : ''; ?>">
    ...
    if (!isset($_SESSION['user_id'])) {
        echo '<a href="http://212.18.224.194/~okt2404/projekt/landing.php">logga in</a>';        
    } else {
        ...
        // echo '<a href="http://212.18.224.194/~okt2404/projekt/index.php">Maskrosaff�ren</a>';  
        echo "</div>";
        ...
        for ($i = 1; $i <= 25; $i++) {
            ...
            if ($i == 3) {
                echo "<div class='tile shop'><a href='http://212.18.224.194/~okt2404/projekt/index.php'>&#8962;</a></div>"; // Display the house symbol ?
            } elseif($i == 2) {
                echo "<div class='tile'><a href='http://212.18.224.194/~okt2404/projekt/landing.php?exit=true'>☺☻</a></div>";
            } elseif ($i == 1) {
                //echo "<div class=''><</div>";
